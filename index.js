...
function addToCart(item) {
 var newItem = {[item]: Math.floor(
   Math.random(1, 101) * 100
 )};
 cart.push(newItem);
...
if (itemsWithPrices.length === 1){
  return console.log(`In your cart, you have ${itemWithPrices.join()}.`)
} else if (itemWithPrices.length === 2) {
  return console.log (`In your cart, you have ${itemWithPrices[0]} and ${itemWithPrices.slice(-1)}.`)
} else {
